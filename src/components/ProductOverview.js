                ...
                <div className="_container _product-overview_wrapper">
                    ...
                    <div className="_product-overview_body">
                        ...
                        <div className="_product-overview_info">
                            <h1 className="_h2 _product-overview_title">{product.name}</h1>
                            <div className="_product-overview_desc">
                                ...
                                <div className="_product-overview_desc_detail">
                                    {product?.desc?.desc ? <p className="_product-overview_desc_text">{product.desc.desc}</p> : ''}
                                    {product?.desc?.key_points ? <>
                                        <ul className="_product-overview_desc_key-points" style={{paddingBottom:'25px'}}>
                                            {
                                              product?.desc?.key_points && product?.desc?.key_points.map((list, index) => (
                                    ...
                                    {product?.desc?.['footer-desc'] ? <p className="_product-overview_desc_footer_text">{product?.desc?.['footer-desc']}</p> : ''}
                                </div>
                            </div>
                            <div className="_product-overview_price">
                                <span className="_product-overview_price_mrp">{product.price}</span>
                                <span className="_product-overview_price_offer">$<span>{product.sale_price}</span></span>
                            </div>
