...
const SnoringSolutions = () => {
    return (
        <>
            <section className="_snoring_solutions">
                <div className="_container _snoring_solutions_wrapper">
                    <div className="_snoring_solutions_info">
                        <h2 className="_snoring_solutions_info_title _sub_h2">
                            Your Answer to Snoring Woes
                        </h2>
                    </div>
                    <ul className="_snoring_solutions_options">
                        <li className="_snoring_solutions_option">
                            ...
                            <div className="_snoring_solutions_option_info">
                                <span className="_snoring_solutions_option_info_title">Snoring Relief Options</span>
                            </div>
                        </li>
                        <li className="_snoring_solutions_option">
                            <div className="_snoring_solutions_option_media">
                            ...
                            <div className="_snoring_solutions_option_info">
                                <span className="_snoring_solutions_option_info_title">Earplugs</span>
                            </div>
                        </li>
                        <li className="_snoring_solutions_option">
                            <div className="_snoring_solutions_option_media">
                            ...
                            <div className="_snoring_solutions_option_info">
                                <span className="_snoring_solutions_option_info_title">Re-stock</span>
                            </div>
                        </li>
                    </ul>
                </div>
...
export default SnoringSolutions;